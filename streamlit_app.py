...
st.markdown(
    '<p class="hero-line">A strategic modeling lens: separate pricing regimes, stronger diagnostics, and clearer uncertainty interpretation.</p>',
    unsafe_allow_html=True,
)
...
with main_tab:
    ...
    st.write(
        ...
        "From a strategic modeling lens, this is a regime problem as much as it is a prediction problem. "
